...
class HandExtractorSpec extends FlatSpec with Matchers with CardFixtures {
  ...
  it should "find find any hand" in {
    handExtractor.getStraightFlush(highCardCards) shouldBe None
    handExtractor.getFourOfAKind(highCardCards) shouldBe None
    handExtractor.getFullHouse(highCardCards) shouldBe None
    handExtractor.getFlush(highCardCards) shouldBe None
    handExtractor.getStraight(highCardCards) shouldBe None
    handExtractor.getThreeOfAKind(highCardCards) shouldBe None
    handExtractor.getTwoPairs(highCardCards) shouldBe None
    handExtractor.getOnePair(highCardCards) shouldBe None
  }
